...
PLUGINS = [
    ...
    },
    {
        ...
        "allow_in_yolo": True,
        "always_confirm": False,
        "input_schema": "target: file path; args: 'start_at=end|start' and optional 'track_task=true'",
        "usage": [
            "{'tool':'async_tail','target':'logs/app.log','args':'start_at=end'}",
            "{'tool':'async_tail','target':'logs/app.log','args':'start_at=end track_task=true'}",
        ],
        "details": [
            ...
            "If track_task=true is passed, the tool adds a task list item to track completion.",
        ],
    },
    {
        "name": "async_bash",
        ...
        "allow_in_yolo": True,
        "always_confirm": True,
        "input_schema": "args: command; to enable task tracking use 'track_task=true -- <command>' (or append track_task=true at end); target: optional cwd",
        "usage": [
            "{'tool':'async_bash','target':'','args':'-- ./long_process.sh'}",
            "{'tool':'async_bash','target':'','args':'track_task=true -- sleep 20'}",
            "{'tool':'async_bash','target':'','args':'sleep 20 track_task=true'}",
        ],
        "details": [
            ...
            "To attach a task list item, prefer: 'track_task=true -- <command>'.",
    ...
    },
    {
        ...
        "allow_in_yolo": True,
        "always_confirm": False,
        "input_schema": "target: job_id (preferred); args: since_seq (int) (or args='job_id since_seq')",
        "usage": [
