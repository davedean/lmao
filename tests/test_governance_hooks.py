...
class GovernanceHooksTests(TestCase):
    ...
    def test_agent_startup_hook(self) -> None:
        ...
        def mock_call_internal(tool_name, target="", args=None, **kwargs):
            if tool_name == "policy":
        ...
        original_method = self.runtime_context.call_tool_internal
        self.runtime_context.call_tool_internal = mock_call_internal
        ...
        def startup_hook(context) -> HookResult:
            ...
            if context.runtime_state.get("current_user_input"):
                policy_result = context.runtime_state.call_tool_internal(
                ...
                if "skill" in prompt.lower():
                    skills_result = context.runtime_state.call_tool_internal(
                        "skills_guide"
                    )
