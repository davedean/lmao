...
class ToolSafetyTests(TestCase):
    ...
    def test_run_tool_read_with_line_range(self) -> None:
        ...
        output = run_tool(call, base=self.base, extra_roots=[], skill_roots=[], git_allowed=False, yolo_enabled=False)
    ...
    def test_write_blocks_top_level_skill_file(self) -> None:
        ...
        result = run_tool(call, base=self.base, extra_roots=[], skill_roots=[skills_root], git_allowed=False, yolo_enabled=False)
    ...
    def test_task_tools_flow(self) -> None:
        ...
        add_out = run_tool(add, base=self.base, extra_roots=[], skill_roots=[], git_allowed=False, yolo_enabled=False, task_manager=manager)
        ...
        complete_out = run_tool(complete, base=self.base, extra_roots=[], skill_roots=[], git_allowed=False, yolo_enabled=False, task_manager=manager)
        complete_payload = json.loads(complete_out)
        self.assertTrue(complete_payload["success"])

        list_out_done = run_tool(list_call, base=self.base, extra_roots=[], skill_roots=[], git_allowed=False, yolo_enabled=False, task_manager=manager)
